...
<div id="edit-passwd">
    ...
    <div class="edit">
        ...
        <input class="edit_inputs" name="Password" type="text" id="password_input" placeholder="<?php echo htmlspecialchars($user['Password']); ?>" required>

        <br><br>

        <button class="submitButton3" type="submit" name="edit-passwd" class="">Сохранить</button>
        <br><br><br>
